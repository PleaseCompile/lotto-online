export default defineEventHandler((event) => {
  ...
  headers.setHeader('Content-Security-Policy', [
    ...
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://fonts.googleapis.com https://fonts.gstatic.com https://api.iconify.design https://api.simplesvg.com https://api.unisvg.com",
